<template>
    <div class="listContent">
        <div class="searchbox">
            <template v-for="(item, index) in templateData.searchTemplate" :key="index">
                <div v-if="item.type === 'input'">
                    ...
                    <el-input v-model="templateData.searchData[item.name]" class="searchItem"
                ...
                <div v-else-if="item.type === 'select'">
                    ...
                    <el-select class="searchItem" v-model="templateData.searchData[item.name]"
                        ...
                        <el-option v-for="(val, ind) in item.options" :key="ind" :label="val.label"
        ...
        <div class="tableBox">
            <el-table :border="true" ref="multipleTableRef" :data="tableData" style="width: 100%"
                ...
                <template v-for="(item,index) in tableHeader" :key="index">
                    <el-table-column v-if="!item.scoped"  :property="item.property" :width="item.width" :label="item.label"></el-table-column>
                    <el-table-column v-else :width="item.width" :label="item.label">
                        <template #default="scope">{{ scope.row[item.property] }}</template>
                    </el-table-column>
                </template>
