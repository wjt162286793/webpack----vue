<template>
            ...
            <el-table @select="selectionHandler" ref="multipleTableRef" :data="tableData" style="width: 100%"
                ...
                <el-table-column label="操作" fixed="right" width="180">
                    <template #default="scope">
                        <el-button type="primary" :icon="View" circle @click="openRiskInfo(scope.row)" />
                        <el-button type="info" :icon="SetUp" circle @click="openFlow(scope.row)" />
                    </template>
                </el-table-column>
            </el-table>
        </div>
    ...
    <el-drawer v-model="drawer" :direction="direction" size="75%">
        ...
        <template #default>
            ...
            <h4>操作记录</h4>
            <div class="rowBox">
                <el-table :data="activeRecord.recordList" style="width: 100%" :border="true" :stripe="true">
