<template>
  <div>
  <div style="border: #efefef solid 1px; height: calc(100vh - 180px);width: 100%;">
    <RelationGraph ref="seeksRelationGraph" :options="userGraphOptions" class="graph" />
  </div>
</div>
</template>
...
function setGraphData() {
  ...
  const invRootNode = { id: 'invRoot', text: '汽车', styleClass: 'c-g-group-node', color: '#FFC5A6', width: 100, height: 50 };
  const personRootNode = { id: 'personRoot', text: '大数据', styleClass: 'c-g-group-node', color: '#B9FFA7', width: 100, height: 50 };
  const asinvRootNode = { id: 'asinvRoot', text: '医疗保健', styleClass: 'c-g-group-node', color: '#FFBEC1', width: 100, height: 50 };
  const branchRootNode = { id: 'branchRoot', text: '高科技', styleClass: 'c-g-group-node', color: '#FFA1F8', width: 100, height: 50 };
